...
#include "kmr_iiwa_commander/PoseRPY.h"
#include <sstream>
#include "iostream"
...
class MoveEnable{
  public:
    void cmdCallback(const kmr_iiwa_commander::PoseRPY::ConstPtr& msg);
};
...
// moveit_visual_tools::MoveItVisualToolsPtr visual_tools_;
  ...
  void MoveEnable::cmdCallback(const kmr_iiwa_commander::PoseRPY::ConstPtr& msg){
