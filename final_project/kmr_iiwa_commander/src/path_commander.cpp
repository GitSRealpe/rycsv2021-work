...
#include "kmr_iiwa_commander/PoseRPYarray.h"
...
class MoveEnable{
  public:
    void cmdCallback(const kmr_iiwa_commander::PoseRPYarray::ConstPtr& msg);
};
...
// moveit_visual_tools::MoveItVisualToolsPtr visual_tools_;
  ...
  void MoveEnable::cmdCallback(const kmr_iiwa_commander::PoseRPYarray::ConstPtr& msg){
    ...
    const robot_state::JointModelGroup* joint_model_group =
        move_group.getCurrentState()->getJointModelGroup("iiwa_arm");
